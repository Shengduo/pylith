...
/** @file modulesrc/friction/RateStateAgeingFHSlipWeakeningVw.i
 *
 * Python interface to C++ RateStateAgeingFHSlipWeakeningVw object.
 */

namespace pylith {
  namespace friction {

    class RateStateAgeingFHSlipWeakeningVw : public FrictionModel
