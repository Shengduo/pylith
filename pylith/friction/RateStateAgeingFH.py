...
## @file pylith/friction/RateStateAgeingFH.py
##
...
from friction import RateStateAgeingFH as ModuleRateStateAgeingFH

# RateStateAgeingFH class
class RateStateAgeingFH(FrictionModel, ModuleRateStateAgeingFH):
  """
  ...
  class Inventory(FrictionModel.Inventory):
    """
    Python object for managing RateStateAgeingFH facilities and properties.
    """
  ...
  def __init__(self, name="RateStateAgeingFH"):
    """
    Constructor.
    """
  ...
  def _configure(self):
    ...
    try:
      ...
      ModuleRateStateAgeingFH.linearSlipRate(self, self.inventory.linearSlipRate)
  ...
  def _createModuleObj(self):
    ...
    """
    ModuleRateStateAgeingFH.__init__(self)
    return
...
def friction_model():
  """
  Factory associated with RateStateAgeingFH.
  """
  return RateStateAgeingFH()
