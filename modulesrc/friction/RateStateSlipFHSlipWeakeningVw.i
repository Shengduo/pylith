...
/** @file modulesrc/friction/RateStateSlipFHSlipWeakeningVw.i
 *
 * Python interface to C++ RateStateSlipFHSlipWeakeningVw object.
 */

namespace pylith {
  namespace friction {

    class RateStateSlipFHSlipWeakeningVw : public FrictionModel
