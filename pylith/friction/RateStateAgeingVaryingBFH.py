...
## @file pylith/friction/RateStateAgeingVaryingBFH.py
##
...
from friction import RateStateAgeingVaryingBFH as ModuleRateStateAgeingVaryingBFH

# RateStateAgeingVaryingBFH class
class RateStateAgeingVaryingBFH(FrictionModel, ModuleRateStateAgeingVaryingBFH):
  """
  ...
  class Inventory(FrictionModel.Inventory):
    """
    Python object for managing RateStateAgeingVaryingBFH facilities and properties.
    """
  ...
  def __init__(self, name="RateStateAgeingVaryingBFH"):
    """
    Constructor.
    """
    ...
    self.availableFields = \
        {'vertex': \
           {'info': ["reference_friction_coefficient",
                     ...
                     "constitutive_parameter_b_initial",
                     "constitutive_parameter_b_final", 
                     "constitutive_parameter_b_distance", 
                     "cohesion",
  ...
  def _configure(self):
    ...
    try:
      ...
      ModuleRateStateAgeingVaryingBFH.linearSlipRate(self, self.inventory.linearSlipRate)
  ...
  def _createModuleObj(self):
    ...
    """
    ModuleRateStateAgeingVaryingBFH.__init__(self)
    return
...
def friction_model():
  """
  Factory associated with RateStateAgeingVaryingBFH.
  """
  return RateStateAgeingVaryingBFH()
