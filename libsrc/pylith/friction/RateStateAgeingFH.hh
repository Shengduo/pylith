...
/** @file libsrc/friction/RateStateAgeingFH.hh
 *
...
private :
  ...
  RateStateAgeingFH(const RateStateAgeingFH&); ///< Not implemented.
  const RateStateAgeingFH& operator=(const RateStateAgeingFH&); ///< Not implemented
