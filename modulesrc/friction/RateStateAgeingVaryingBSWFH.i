...
/** @file modulesrc/friction/RateStateAgeingVaryingBSWFH.i
 *
 * Python interface to C++ RateStateAgeingVaryingBSWFH object.
 */

namespace pylith {
  namespace friction {

    class RateStateAgeingVaryingBSWFH : public FrictionModel
