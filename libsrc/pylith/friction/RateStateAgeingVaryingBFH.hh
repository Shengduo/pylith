...
/** @file libsrc/friction/RateStateAgeingVaryingBFH.hh
 *
...
#if !defined(pylith_friction_ratestateageingvaryingbfh_hh)
#define pylith_friction_RateStateAgeingVaryingbfh_hh

// Include directives ---------------------------------------------------
#include "FrictionModel.hh" // ISA FrictionModel

// RateStateAgeingVaryingBFH -------------------------------------------------------
...
class pylith::friction::RateStateAgeingVaryingBFH : public FrictionModel
{ // class RateStateAgeingVaryingBFH
  friend class TestRateStateAgeingVaryingBFH; // unit testing

  // PUBLIC METHODS /////////////////////////////////////////////////////
public :

  /// Default constructor.
  RateStateAgeingVaryingBFH(void);
...
private :
  ...
  static const int p_b_initial;
  static const int p_b_final;
  static const int p_b_distance;
  ...
  static const int db_b_initial;
  static const int db_b_final;
  static const int db_b_distance;
...
private :
  ...
  RateStateAgeingVaryingBFH(const RateStateAgeingVaryingBFH&); ///< Not implemented.
  const RateStateAgeingVaryingBFH& operator=(const RateStateAgeingVaryingBFH&); ///< Not implemented

}; // class RateStateAgeingVaryingBFH

#endif // pylith_friction_RateStateAgeingVaryingBFH_hh
