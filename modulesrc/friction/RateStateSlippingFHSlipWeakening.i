...
/** @file modulesrc/friction/RateStateAgeingFHSlipWeakening.i
 *
 * Python interface to C++ RateStateAgeingFHSlipWeakening object.
 */

namespace pylith {
  namespace friction {

    class RateStateAgeingFHSlipWeakening : public FrictionModel
