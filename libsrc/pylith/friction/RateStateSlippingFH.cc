...
#include "RateStateSlippingFH.hh" // implementation of object methods
...
namespace pylith {
  namespace friction {
    namespace _RateStateSlippingFH {
  ...
  "flash_heating_slip_rate"
    ...
    } // _RateStateSlippingFH
  } // friction
} // pylith

// Indices of physical properties
const int pylith::friction::RateStateSlippingFH::p_coef = 0;
const int pylith::friction::RateStateSlippingFH::p_slipRate0 = 
  pylith::friction::RateStateSlippingFH::p_coef + 1;
const int pylith::friction::RateStateSlippingFH::p_L = 
  pylith::friction::RateStateSlippingFH::p_slipRate0 + 1;
const int pylith::friction::RateStateSlippingFH::p_a = 
  pylith::friction::RateStateSlippingFH::p_L + 1;
const int pylith::friction::RateStateSlippingFH::p_b = 
  pylith::friction::RateStateSlippingFH::p_a + 1;
const int pylith::friction::RateStateSlippingFH::p_cohesion =
  pylith::friction::RateStateSlippingFH::p_b + 1;
const int pylith::friction::RateStateSlippingFH::p_fwcoef =
  pylith::friction::RateStateSlippingFH::p_cohesion + 1;
const int pylith::friction::RateStateSlippingFH::p_fwSlipRate =
  pylith::friction::RateStateSlippingFH::p_fwcoef + 1;

// Indices of database values (order must match dbProperties)
const int pylith::friction::RateStateSlippingFH::db_coef = 0;
const int pylith::friction::RateStateSlippingFH::db_slipRate0 = 
  pylith::friction::RateStateSlippingFH::db_coef + 1;
const int pylith::friction::RateStateSlippingFH::db_L = 
  pylith::friction::RateStateSlippingFH::db_slipRate0 + 1;
const int pylith::friction::RateStateSlippingFH::db_a = 
  pylith::friction::RateStateSlippingFH::db_L + 1;
const int pylith::friction::RateStateSlippingFH::db_b = 
  pylith::friction::RateStateSlippingFH::db_a + 1;
const int pylith::friction::RateStateSlippingFH::db_cohesion =
  pylith::friction::RateStateSlippingFH::db_b + 1;
const int pylith::friction::RateStateSlippingFH::db_fwcoef =
  pylith::friction::RateStateSlippingFH::db_cohesion + 1;
const int pylith::friction::RateStateSlippingFH::db_fwSlipRate =
  pylith::friction::RateStateSlippingFH::db_fwcoef + 1;

// Indices of state variables.
const int pylith::friction::RateStateSlippingFH::s_state = 0;

// Indices of database values (order must match dbProperties)
const int pylith::friction::RateStateSlippingFH::db_state = 0;

// ----------------------------------------------------------------------
// Default constructor.
pylith::friction::RateStateSlippingFH::RateStateSlippingFH(void) :
  FrictionModel(materials::Metadata(_RateStateSlippingFH::properties,
				    _RateStateSlippingFH::numProperties,
				    _RateStateSlippingFH::dbProperties,
				    _RateStateSlippingFH::numDBProperties,
				    _RateStateSlippingFH::stateVars,
				    _RateStateSlippingFH::numStateVars,
				    _RateStateSlippingFH::dbStateVars,
				    _RateStateSlippingFH::numDBStateVars)),
...
void
pylith::friction::RateStateSlippingFH::linearSlipRate(const PylithScalar value)
{ // linearSlipRate
  if (value < 0.0) {
...
void
pylith::friction::RateStateSlippingFH::_dbToProperties(PylithScalar* const propValues,
						   const scalar_array& dbValues) const
{ // _dbToProperties
  assert(propValues);
  const int numDBValues = dbValues.size();
  assert(_RateStateSlippingFH::numDBProperties == numDBValues);
...
void
pylith::friction::RateStateSlippingFH::_nondimProperties(PylithScalar* const values,
						    const int nvalues) const
{ // _nondimProperties
  assert(_normalizer);
  assert(values);
  assert(nvalues == _RateStateSlippingFH::numProperties);
...
void
pylith::friction::RateStateSlippingFH::_dimProperties(PylithScalar* const values,
						  const int nvalues) const
{ // _dimProperties
  assert(_normalizer);
  assert(values);
...
void
pylith::friction::RateStateSlippingFH::_dbToStateVars(PylithScalar* const stateValues,
						  const scalar_array& dbValues) const
{ // _dbToStateVars
  assert(stateValues);
  const int numDBValues = dbValues.size();
  assert(_RateStateSlippingFH::numDBStateVars == numDBValues);
...
void
pylith::friction::RateStateSlippingFH::_nondimStateVars(PylithScalar* const values,
						    const int nvalues) const
{ // _nondimStateVars
  assert(_normalizer);
  assert(values);
  assert(nvalues == _RateStateSlippingFH::numStateVars);
...
void
pylith::friction::RateStateSlippingFH::_dimStateVars(PylithScalar* const values,
						 const int nvalues) const
{ // _dimStateVars
  assert(_normalizer);
  assert(values);
...
PylithScalar
pylith::friction::RateStateSlippingFH::_calcFriction(const PylithScalar t,
...
{ // _calcFriction
  assert(properties);
  assert(_RateStateSlippingFH::numProperties == numProperties);
  assert(numStateVars);
  assert(_RateStateSlippingFH::numStateVars == numStateVars);
...
// state variables.
PylithScalar
pylith::friction::RateStateSlippingFH::_calcFrictionDeriv(const PylithScalar t,
						      const PylithScalar slip,
						      const PylithScalar slipRate,
						      const PylithScalar normalTraction,
						      const PylithScalar* properties,
...
void
pylith::friction::RateStateSlippingFH::_updateStateVars(const PylithScalar t,
						    const PylithScalar slip,
						    const PylithScalar slipRate,
						    const PylithScalar normalTraction,
