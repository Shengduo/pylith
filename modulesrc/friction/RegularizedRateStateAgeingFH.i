...
/** @file modulesrc/friction/RegularizedRateStateAgeingFH.i
 *
 * Python interface to C++ RegularizedRateStateAgeingFH object.
 */

namespace pylith {
  namespace friction {

    class RegularizedRateStateAgeingFH : public FrictionModel
