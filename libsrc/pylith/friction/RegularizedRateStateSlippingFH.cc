...
#include "RegularizedRateStateSlippingFH.hh" // implementation of object methods
...
namespace pylith {
  namespace friction {
    namespace _RegularizedRateStateSlippingFH {
  ...
  "flash_heating_slip_rate"
    ...
    } // _RegularizedRateStateSlippingFH
  } // friction
} // pylith

// Indices of physical properties
const int pylith::friction::RegularizedRateStateSlippingFH::p_coef = 0;
const int pylith::friction::RegularizedRateStateSlippingFH::p_slipRate0 = 
  pylith::friction::RegularizedRateStateSlippingFH::p_coef + 1;
const int pylith::friction::RegularizedRateStateSlippingFH::p_L = 
  pylith::friction::RegularizedRateStateSlippingFH::p_slipRate0 + 1;
const int pylith::friction::RegularizedRateStateSlippingFH::p_a = 
  pylith::friction::RegularizedRateStateSlippingFH::p_L + 1;
const int pylith::friction::RegularizedRateStateSlippingFH::p_b = 
  pylith::friction::RegularizedRateStateSlippingFH::p_a + 1;
const int pylith::friction::RegularizedRateStateSlippingFH::p_cohesion =
  pylith::friction::RegularizedRateStateSlippingFH::p_b + 1;
const int pylith::friction::RegularizedRateStateSlippingFH::p_fwcoef =
  pylith::friction::RegularizedRateStateSlippingFH::p_cohesion + 1;
const int pylith::friction::RegularizedRateStateSlippingFH::p_fwSlipRate =
  pylith::friction::RegularizedRateStateSlippingFH::p_fwcoef + 1;

// Indices of database values (order must match dbProperties)
const int pylith::friction::RegularizedRateStateSlippingFH::db_coef = 0;
const int pylith::friction::RegularizedRateStateSlippingFH::db_slipRate0 = 
  pylith::friction::RegularizedRateStateSlippingFH::db_coef + 1;
const int pylith::friction::RegularizedRateStateSlippingFH::db_L = 
  pylith::friction::RegularizedRateStateSlippingFH::db_slipRate0 + 1;
const int pylith::friction::RegularizedRateStateSlippingFH::db_a = 
  pylith::friction::RegularizedRateStateSlippingFH::db_L + 1;
const int pylith::friction::RegularizedRateStateSlippingFH::db_b = 
  pylith::friction::RegularizedRateStateSlippingFH::db_a + 1;
const int pylith::friction::RegularizedRateStateSlippingFH::db_cohesion =
  pylith::friction::RegularizedRateStateSlippingFH::db_b + 1;
const int pylith::friction::RegularizedRateStateSlippingFH::db_fwcoef =
  pylith::friction::RegularizedRateStateSlippingFH::db_cohesion + 1;
const int pylith::friction::RegularizedRateStateSlippingFH::db_fwSlipRate =
  pylith::friction::RegularizedRateStateSlippingFH::db_fwcoef + 1;

// Indices of state variables.
const int pylith::friction::RegularizedRateStateSlippingFH::s_state = 0;

// Indices of database values (order must match dbProperties)
const int pylith::friction::RegularizedRateStateSlippingFH::db_state = 0;

// ----------------------------------------------------------------------
// Default constructor.
pylith::friction::RegularizedRateStateSlippingFH::RegularizedRateStateSlippingFH(void) :
  FrictionModel(materials::Metadata(_RegularizedRateStateSlippingFH::properties,
				    _RegularizedRateStateSlippingFH::numProperties,
				    _RegularizedRateStateSlippingFH::dbProperties,
				    _RegularizedRateStateSlippingFH::numDBProperties,
				    _RegularizedRateStateSlippingFH::stateVars,
				    _RegularizedRateStateSlippingFH::numStateVars,
				    _RegularizedRateStateSlippingFH::dbStateVars,
				    _RegularizedRateStateSlippingFH::numDBStateVars)),
...
void
pylith::friction::RegularizedRateStateSlippingFH::linearSlipRate(const PylithScalar value)
{ // linearSlipRate
  if (value < 0.0) {
...
void
pylith::friction::RegularizedRateStateSlippingFH::_dbToProperties(PylithScalar* const propValues,
						   const scalar_array& dbValues) const
{ // _dbToProperties
  assert(propValues);
  const int numDBValues = dbValues.size();
  assert(_RegularizedRateStateSlippingFH::numDBProperties == numDBValues);
...
void
pylith::friction::RegularizedRateStateSlippingFH::_nondimProperties(PylithScalar* const values,
						    const int nvalues) const
{ // _nondimProperties
  assert(_normalizer);
  assert(values);
  assert(nvalues == _RegularizedRateStateSlippingFH::numProperties);
...
void
pylith::friction::RegularizedRateStateSlippingFH::_dimProperties(PylithScalar* const values,
						  const int nvalues) const
{ // _dimProperties
  assert(_normalizer);
  assert(values);
...
void
pylith::friction::RegularizedRateStateSlippingFH::_dbToStateVars(PylithScalar* const stateValues,
						  const scalar_array& dbValues) const
{ // _dbToStateVars
  assert(stateValues);
  const int numDBValues = dbValues.size();
  assert(_RegularizedRateStateSlippingFH::numDBStateVars == numDBValues);
...
void
pylith::friction::RegularizedRateStateSlippingFH::_nondimStateVars(PylithScalar* const values,
						    const int nvalues) const
{ // _nondimStateVars
  assert(_normalizer);
  assert(values);
  assert(nvalues == _RegularizedRateStateSlippingFH::numStateVars);
...
void
pylith::friction::RegularizedRateStateSlippingFH::_dimStateVars(PylithScalar* const values,
						 const int nvalues) const
{ // _dimStateVars
  assert(_normalizer);
  assert(values);
...
PylithScalar
pylith::friction::RegularizedRateStateSlippingFH::_calcFriction(const PylithScalar t,
...
{ // _calcFriction
  assert(properties);
  assert(_RegularizedRateStateSlippingFH::numProperties == numProperties);
  assert(numStateVars);
  assert(_RegularizedRateStateSlippingFH::numStateVars == numStateVars);
  ...
  if (normalTraction <= 0.0) {
    ...
    // Regularized rate and state friction instead
    mu_f = a * asinh(slipRate / 2. / slipRate0 * exp((f0 + b * log(slipRate0 * theta / L)) / a));
...
// state variables.
PylithScalar
pylith::friction::RegularizedRateStateSlippingFH::_calcFrictionDeriv(const PylithScalar t,
						      const PylithScalar slip,
						      const PylithScalar slipRate,
						      const PylithScalar normalTraction,
						      const PylithScalar* properties,
...
{ // _calcFrictionDeriv
  ...
  if (normalTraction <= 0.0) {
    ...
    const PylithScalar Q1 = 0.5 / slipRate0 * exp((f0 + b * log(slipRate0 * theta / L)) / a);
    frictionDeriv = -normalTraction * a * Q1 / sqrt(1 + pow(Q1 * slipRate, 2)) / _dt / (1. + L / theta / Vw);
    /**
    if (slipRate >= slipRateLinear) {
...
void
pylith::friction::RegularizedRateStateSlippingFH::_updateStateVars(const PylithScalar t,
						    const PylithScalar slip,
						    const PylithScalar slipRate,
						    const PylithScalar normalTraction,
