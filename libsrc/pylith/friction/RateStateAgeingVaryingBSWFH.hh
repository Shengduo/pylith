...
/** @file libsrc/friction/RateStateAgeingVaryingBSWFH.hh
 *
...
#if !defined(pylith_friction_RateStateAgeingVaryingBSWFH_hh)
#define pylith_friction_RateStateAgeingVaryingBSWFH_hh

// Include directives ---------------------------------------------------
#include "FrictionModel.hh" // ISA FrictionModel

// RateStateAgeingVaryingBSWFH -------------------------------------------------------
...
class pylith::friction::RateStateAgeingVaryingBSWFH : public FrictionModel
{ // class RateStateAgeingVaryingBSWFH
  friend class TestRateStateAgeingVaryingBSWFH; // unit testing

  // PUBLIC METHODS /////////////////////////////////////////////////////
public :

  /// Default constructor.
  RateStateAgeingVaryingBSWFH(void);
...
private :
  ...
  RateStateAgeingVaryingBSWFH(const RateStateAgeingVaryingBSWFH&); ///< Not implemented.
  const RateStateAgeingVaryingBSWFH& operator=(const RateStateAgeingVaryingBSWFH&); ///< Not implemented

}; // class RateStateAgeingVaryingBSWFH

#endif // pylith_friction_RateStateAgeingVaryingBSWFH_hh
