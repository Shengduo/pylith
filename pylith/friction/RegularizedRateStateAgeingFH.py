...
## @file pylith/friction/RegularizedRateStateAgeingFH.py
##
...
from friction import RegularizedRateStateAgeingFH as ModuleRegularizedRateStateAgeingFH

# RegularizedRateStateAgeingFH class
class RegularizedRateStateAgeingFH(FrictionModel, ModuleRegularizedRateStateAgeingFH):
  """
  ...
  class Inventory(FrictionModel.Inventory):
    """
    Python object for managing RegularizedRateStateAgeingFH facilities and properties.
    """
  ...
  def __init__(self, name="RegularizedRateStateAgeingFH"):
    """
    Constructor.
    """
  ...
  def _configure(self):
    ...
    try:
      ...
      ModuleRegularizedRateStateAgeingFH.linearSlipRate(self, self.inventory.linearSlipRate)
  ...
  def _createModuleObj(self):
    ...
    """
    ModuleRegularizedRateStateAgeingFH.__init__(self)
    return
...
def friction_model():
  """
  Factory associated with RegularizedRateStateAgeingFH.
  """
  return RegularizedRateStateAgeingFH()
