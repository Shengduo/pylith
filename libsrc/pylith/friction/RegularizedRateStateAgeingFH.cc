...
#include "RegularizedRateStateAgeingFH.hh" // implementation of object methods
...
namespace pylith {
  namespace friction {
    namespace _RegularizedRateStateAgeingFH {
  ...
  "flash_heating_slip_rate"
    ...
    } // _RegularizedRateStateAgeingFH
  } // friction
} // pylith

// Indices of physical properties
const int pylith::friction::RegularizedRateStateAgeingFH::p_coef = 0;
const int pylith::friction::RegularizedRateStateAgeingFH::p_slipRate0 = 
  pylith::friction::RegularizedRateStateAgeingFH::p_coef + 1;
const int pylith::friction::RegularizedRateStateAgeingFH::p_L = 
  pylith::friction::RegularizedRateStateAgeingFH::p_slipRate0 + 1;
const int pylith::friction::RegularizedRateStateAgeingFH::p_a = 
  pylith::friction::RegularizedRateStateAgeingFH::p_L + 1;
const int pylith::friction::RegularizedRateStateAgeingFH::p_b = 
  pylith::friction::RegularizedRateStateAgeingFH::p_a + 1;
const int pylith::friction::RegularizedRateStateAgeingFH::p_cohesion =
  pylith::friction::RegularizedRateStateAgeingFH::p_b + 1;
const int pylith::friction::RegularizedRateStateAgeingFH::p_fwcoef =
  pylith::friction::RegularizedRateStateAgeingFH::p_cohesion + 1;
const int pylith::friction::RegularizedRateStateAgeingFH::p_fwSlipRate =
  pylith::friction::RegularizedRateStateAgeingFH::p_fwcoef + 1;

// Indices of database values (order must match dbProperties)
const int pylith::friction::RegularizedRateStateAgeingFH::db_coef = 0;
const int pylith::friction::RegularizedRateStateAgeingFH::db_slipRate0 = 
  pylith::friction::RegularizedRateStateAgeingFH::db_coef + 1;
const int pylith::friction::RegularizedRateStateAgeingFH::db_L = 
  pylith::friction::RegularizedRateStateAgeingFH::db_slipRate0 + 1;
const int pylith::friction::RegularizedRateStateAgeingFH::db_a = 
  pylith::friction::RegularizedRateStateAgeingFH::db_L + 1;
const int pylith::friction::RegularizedRateStateAgeingFH::db_b = 
  pylith::friction::RegularizedRateStateAgeingFH::db_a + 1;
const int pylith::friction::RegularizedRateStateAgeingFH::db_cohesion =
  pylith::friction::RegularizedRateStateAgeingFH::db_b + 1;
const int pylith::friction::RegularizedRateStateAgeingFH::db_fwcoef =
  pylith::friction::RegularizedRateStateAgeingFH::db_cohesion + 1;
const int pylith::friction::RegularizedRateStateAgeingFH::db_fwSlipRate =
  pylith::friction::RegularizedRateStateAgeingFH::db_fwcoef + 1;

// Indices of state variables.
const int pylith::friction::RegularizedRateStateAgeingFH::s_state = 0;

// Indices of database values (order must match dbProperties)
const int pylith::friction::RegularizedRateStateAgeingFH::db_state = 0;

// ----------------------------------------------------------------------
// Default constructor.
pylith::friction::RegularizedRateStateAgeingFH::RegularizedRateStateAgeingFH(void) :
  FrictionModel(materials::Metadata(_RegularizedRateStateAgeingFH::properties,
				    _RegularizedRateStateAgeingFH::numProperties,
				    _RegularizedRateStateAgeingFH::dbProperties,
				    _RegularizedRateStateAgeingFH::numDBProperties,
				    _RegularizedRateStateAgeingFH::stateVars,
				    _RegularizedRateStateAgeingFH::numStateVars,
				    _RegularizedRateStateAgeingFH::dbStateVars,
				    _RegularizedRateStateAgeingFH::numDBStateVars)),
...
void
pylith::friction::RegularizedRateStateAgeingFH::linearSlipRate(const PylithScalar value)
{ // linearSlipRate
  if (value < 0.0) {
...
void
pylith::friction::RegularizedRateStateAgeingFH::_dbToProperties(PylithScalar* const propValues,
						   const scalar_array& dbValues) const
{ // _dbToProperties
  assert(propValues);
  const int numDBValues = dbValues.size();
  assert(_RegularizedRateStateAgeingFH::numDBProperties == numDBValues);
...
void
pylith::friction::RegularizedRateStateAgeingFH::_nondimProperties(PylithScalar* const values,
						    const int nvalues) const
{ // _nondimProperties
  assert(_normalizer);
  assert(values);
  assert(nvalues == _RegularizedRateStateAgeingFH::numProperties);
...
void
pylith::friction::RegularizedRateStateAgeingFH::_dimProperties(PylithScalar* const values,
						  const int nvalues) const
{ // _dimProperties
  assert(_normalizer);
  assert(values);
...
void
pylith::friction::RegularizedRateStateAgeingFH::_dbToStateVars(PylithScalar* const stateValues,
						  const scalar_array& dbValues) const
{ // _dbToStateVars
  assert(stateValues);
  const int numDBValues = dbValues.size();
  assert(_RegularizedRateStateAgeingFH::numDBStateVars == numDBValues);
...
void
pylith::friction::RegularizedRateStateAgeingFH::_nondimStateVars(PylithScalar* const values,
						    const int nvalues) const
{ // _nondimStateVars
  assert(_normalizer);
  assert(values);
  assert(nvalues == _RegularizedRateStateAgeingFH::numStateVars);
...
void
pylith::friction::RegularizedRateStateAgeingFH::_dimStateVars(PylithScalar* const values,
						 const int nvalues) const
{ // _dimStateVars
  assert(_normalizer);
  assert(values);
...
PylithScalar
pylith::friction::RegularizedRateStateAgeingFH::_calcFriction(const PylithScalar t,
...
{ // _calcFriction
  assert(properties);
  assert(_RegularizedRateStateAgeingFH::numProperties == numProperties);
  assert(numStateVars);
  assert(_RegularizedRateStateAgeingFH::numStateVars == numStateVars);
...
// state variables.
PylithScalar
pylith::friction::RegularizedRateStateAgeingFH::_calcFrictionDeriv(const PylithScalar t,
						      const PylithScalar slip,
						      const PylithScalar slipRate,
						      const PylithScalar normalTraction,
						      const PylithScalar* properties,
...
void
pylith::friction::RegularizedRateStateAgeingFH::_updateStateVars(const PylithScalar t,
						    const PylithScalar slip,
						    const PylithScalar slipRate,
						    const PylithScalar normalTraction,
