...
/** @file libsrc/friction/RateStateAgeingFHSlipWeakening.hh
 *
...
#if !defined(pylith_friction_ratestateageingfhslipweakening_hh)
#define pylith_friction_ratestateageingfhslipweakening_hh

// Include directives ---------------------------------------------------
#include "FrictionModel.hh" // ISA FrictionModel

// RateStateAgeingFHSlipWeakening -------------------------------------------------------
...
class pylith::friction::RateStateAgeingFHSlipWeakening : public FrictionModel
{ // class RateStateAgeingFHSlipWeakening
  friend class TestRateStateAgeingFHSlipWeakening; // unit testing

  // PUBLIC METHODS /////////////////////////////////////////////////////
public :

  /// Default constructor.
  RateStateAgeingFHSlipWeakening(void);
...
private :
  ...
  RateStateAgeingFHSlipWeakening(const RateStateAgeingFHSlipWeakening&); ///< Not implemented.
  const RateStateAgeingFHSlipWeakening& operator=(const RateStateAgeingFHSlipWeakening&); ///< Not implemented
