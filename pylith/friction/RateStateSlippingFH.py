...
## @file pylith/friction/RateStateSlippingFH.py
##
...
from friction import RateStateSlippingFH as ModuleRateStateSlippingFH

# RateStateSlippingFH class
class RateStateSlippingFH(FrictionModel, ModuleRateStateSlippingFH):
  """
  ...
  class Inventory(FrictionModel.Inventory):
    """
    Python object for managing RateStateSlippingFH facilities and properties.
    """
  ...
  def __init__(self, name="RateStateSlippingFH"):
    """
    Constructor.
    """
  ...
  def _configure(self):
    ...
    try:
      ...
      ModuleRateStateSlippingFH.linearSlipRate(self, self.inventory.linearSlipRate)
  ...
  def _createModuleObj(self):
    ...
    """
    ModuleRateStateSlippingFH.__init__(self)
    return
...
def friction_model():
  """
  Factory associated with RateStateSlippingFH.
  """
  return RateStateSlippingFH()
