...
## @file pylith/friction/RateStateAgeingVaryingBSWFH.py
##
...
from friction import RateStateAgeingVaryingBSWFH as ModuleRateStateAgeingVaryingBSWFH

# RateStateAgeingVaryingBSWFH class
class RateStateAgeingVaryingBSWFH(FrictionModel, ModuleRateStateAgeingVaryingBSWFH):
  """
  ...
  class Inventory(FrictionModel.Inventory):
    """
    Python object for managing RateStateAgeingVaryingBSWFH facilities and properties.
    """
  ...
  def __init__(self, name="RateStateAgeingVaryingBSWFH"):
    """
    Constructor.
    """
  ...
  def _configure(self):
    ...
    try:
      ...
      ModuleRateStateAgeingVaryingBSWFH.linearSlipRate(self, self.inventory.linearSlipRate)
  ...
  def _createModuleObj(self):
    ...
    """
    ModuleRateStateAgeingVaryingBSWFH.__init__(self)
    return
...
def friction_model():
  """
  Factory associated with RateStateAgeingVaryingBSWFH.
  """
  return RateStateAgeingVaryingBSWFH()
