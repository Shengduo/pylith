...
/** @file modulesrc/friction/RegularizedRateStateSlippingFH.i
 *
 * Python interface to C++ RegularizedRateStateSlippingFH object.
 */

namespace pylith {
  namespace friction {

    class RegularizedRateStateSlippingFH : public FrictionModel
