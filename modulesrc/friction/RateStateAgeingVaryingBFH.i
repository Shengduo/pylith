...
/** @file modulesrc/friction/RateStateAgeingVaryingBFH.i
 *
 * Python interface to C++ RateStateAgeingVaryingBFH object.
 */

namespace pylith {
  namespace friction {

    class RateStateAgeingVaryingBFH : public FrictionModel
